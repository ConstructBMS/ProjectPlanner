...
const GlobalSearch = () => {
  ...
  const getResultItemStyle = (index) => {
    const baseStyle = 'flex items-center p-3 hover:bg-gray-50 cursor-pointer transition-colors duration-150';
    const selectedStyle = index === selectedResultIndex ? 'bg-blue-50 border-l-4 border-blue-500' : '';
        ...
        <div className="absolute top-full left-0 right-0 mt-1 bg-white border border-gray-200 rounded-lg shadow-lg z-50 max-h-96 overflow-y-auto">
          ...
          {!isSearching && searchResults.length === 0 && searchQuery.trim().length >= 2 && (
            <div className="p-4 text-center text-gray-500">
              ...
              <p className="text-xs text-gray-400 mt-1">Try searching for tasks, resources, or projects</p>
            </div>
          )}
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-2 ml-2">
                          ...
                          {result.type === 'task' && result.priority && (
                            <span className={getPriorityBadgeStyle(result.priority)}>
                              {result.priority}
                            </span>
                          )}
                        </div>
                      ...
                      <div className="flex items-center space-x-4 mt-2">
                        ...
                        {(result.type === 'task' || result.type === 'project') && result.progress !== undefined && (
