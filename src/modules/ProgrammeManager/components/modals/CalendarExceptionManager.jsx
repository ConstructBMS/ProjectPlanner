...
const CalendarExceptionManager = ({
  ...
  const handleEditException = useCallback(
    async (exceptionId, updates) => {
      try {
        const updatedCalendar = updateExceptionInCalendar(
          calendar,
          exceptionId,
          updates
        );
  ...
  const handleDeleteException = useCallback(
    async exceptionId => {
      ...
      try {
        const updatedCalendar = removeExceptionFromCalendar(
          calendar,
          exceptionId
        );
        await onCalendarUpdate(updatedCalendar);
  ...
  const handleDeleteSelected = useCallback(async () => {
    ...
    if (
      !confirm(
        `Are you sure you want to delete ${selectedExceptions.length} exceptions?`
      )
    )
      return;
    ...
    try {
      ...
      for (const exceptionId of selectedExceptions) {
        updatedCalendar = removeExceptionFromCalendar(
          updatedCalendar,
          exceptionId
        );
      }
                ...
                <div className='space-y-4'>
                  <div>
                    ...
                    <input
                      ...
                      onChange={e =>
                        handleSingleExceptionChange('date', e.target.value)
                      }
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={e =>
                        handleSingleExceptionChange('type', e.target.value)
                      }
                      className='w-full px-3 py-2 border border-gray-300 rounded focus:ring-2 focus:ring-blue-500 focus:border-blue-500'
                    >
                      <option
                        value={DEFAULT_EXCEPTION_CONFIG.exceptionTypes.HOLIDAY}
                      >
                        Holiday
                      </option>
                      <option
                        value={
                          DEFAULT_EXCEPTION_CONFIG.exceptionTypes.SITE_SHUTDOWN
                        }
                      >
                        Site Shutdown
                      </option>
                      <option
                        value={
                          DEFAULT_EXCEPTION_CONFIG.exceptionTypes.MAINTENANCE
                        }
                      >
                        Maintenance
                      </option>
                      <option
                        value={DEFAULT_EXCEPTION_CONFIG.exceptionTypes.WEATHER}
                      >
                        Weather
                      </option>
                      <option
                        value={DEFAULT_EXCEPTION_CONFIG.exceptionTypes.CUSTOM}
                      >
                        Custom
                      </option>
                    </select>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={e =>
                        handleSingleExceptionChange('reason', e.target.value)
                      }
                      className='w-full px-3 py-2 border border-gray-300 rounded focus:ring-2 focus:ring-blue-500 focus:border-blue-500'
                ...
                <div className='space-y-4'>
                  <div>
                    ...
                    <input
                      ...
                      onChange={e =>
                        handleRangeExceptionChange('startDate', e.target.value)
                      }
                      className='w-full px-3 py-2 border border-gray-300 rounded focus:ring-2 focus:ring-blue-500 focus:border-blue-500'
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={e =>
                        handleRangeExceptionChange('endDate', e.target.value)
                      }
                      className='w-full px-3 py-2 border border-gray-300 rounded focus:ring-2 focus:ring-blue-500 focus:border-blue-500'
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={e =>
                        handleRangeExceptionChange('type', e.target.value)
                      }
                      className='w-full px-3 py-2 border border-gray-300 rounded focus:ring-2 focus:ring-blue-500 focus:border-blue-500'
                    >
                      <option
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={e =>
                        handleRangeExceptionChange('reason', e.target.value)
                      }
                      className='w-full px-3 py-2 border border-gray-300 rounded focus:ring-2 focus:ring-blue-500 focus:border-blue-500'
            ...
            <div className='flex items-center justify-between mb-6'>
              ...
              <div className='flex items-center gap-4'>
                ...
                >
                  ...
                  <option
                    value={DEFAULT_EXCEPTION_CONFIG.exceptionTypes.MAINTENANCE}
                  >
                    Maintenance
                  </option>
                  <option
                          ...
                          <input
                            ...
                            onChange={e => {
                              if (e.target.checked) {
                                ...
                                setSelectedExceptions(prev =>
                                  prev.filter(id => id !== exception.id)
                                );
                              }
                            }}
                            className='rounded border-gray-300 text-blue-600 focus:ring-blue-500'
                        ...
                        <div className='grid grid-cols-2 gap-4'>
                          <div>
                            ...
                            <input
                              ...
                              onBlur={e =>
                                handleEditException(exception.id, {
                          ...
                          <div>
                            ...
                            >
                              <option
                                value={
                                  DEFAULT_EXCEPTION_CONFIG.exceptionTypes
                                    .HOLIDAY
                                }
                              >
                                Holiday
                              ...
                              <option
                                value={
                                  DEFAULT_EXCEPTION_CONFIG.exceptionTypes.CUSTOM
                                }
                              >
                                Custom
                              </option>
