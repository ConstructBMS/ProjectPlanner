...
const DependencyLagModal = ({ 
  ...
  // Link type options
  const linkTypes = [
    { value: 'FS', label: 'Finish-to-Start', description: 'Task B starts after Task A finishes' },
    { value: 'SS', label: 'Start-to-Start', description: 'Task B starts after Task A starts' },
    { value: 'FF', label: 'Finish-to-Finish', description: 'Task B finishes after Task A finishes' },
    { value: 'SF', label: 'Start-to-Finish', description: 'Task B finishes after Task A starts' },
  ];
