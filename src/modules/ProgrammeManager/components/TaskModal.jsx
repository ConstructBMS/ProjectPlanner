...
import { XMarkIcon, CalendarIcon, ClockIcon, DocumentTextIcon, SwatchIcon, StarIcon } from '@heroicons/react/24/outline';
      ...
      <div className="bg-white rounded-xl shadow-xl max-w-[500px] w-full max-h-[90vh] overflow-hidden animate-in fade-in-0 zoom-in-95 duration-200">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-semibold text-gray-900">Task Properties</h2>
          </div>
          <button
            onClick={onClose}
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <div className="flex items-center">
                ...
                />
                <span className="ml-2 text-sm text-gray-700">Mark as milestone</span>
              </div>
            </div>
          </div>
