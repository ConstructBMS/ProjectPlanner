...
const CreateTemplateModal = ({ isOpen, onClose, onSubmit, form, setForm, processing }) => {
...
const TemplateDetailsModal = ({ isOpen, onClose, template, onApply, processing }) => {
        ...
        <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full">
          ...
          <div className="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
            <button
              ...
              className="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-blue-600 text-base font-medium text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 sm:ml-3 sm:w-auto sm:text-sm disabled:opacity-50"
            >
              {processing ? 'Creating Project...' : 'Create Project from Template'}
            </button>
            <button
              type="button"
              onClick={onClose}
...
const DeleteConfirmationModal = ({ isOpen, onClose, template, onConfirm, processing }) => {
  if (!isOpen || !template) return null;
...
const ImportModal = ({ isOpen, onClose, onImport, fileInputRef, processing }) => {
  if (!isOpen) return null;
